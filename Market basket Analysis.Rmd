...
# 🛒 Market Basket Analysis (MBA) with R
...
Stored as sparse transaction matrix

🔍 Step 2: Explore the Data

summary(Groceries)

it explains. how frequent each item has been bought and length of each basket, 
such as frequency of item bought:
...
Clearly, whole milk appears frequently across baskets.

⚡ Step 3:Frequent Itemset Mining (Eclat)
We use Eclat algorithm to find frequent itemsets.


F_I <- eclat(Groceries, parameter = list(supp=0.01, maxlen=10))
inspect(head(F_I, 10))
Found 333 itemsets with minimum support 1%

Example: {whole milk, yogurt} appears in 2.9% transactions

📊 Step 4:  Item Frequency Analysis and visualizing according to no. and percentage.
